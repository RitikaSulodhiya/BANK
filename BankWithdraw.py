...
class MyWithdraw(Frame):
    def _init_(self,master):
        super().__init__(master)

        l1=Label(self,text="Account No",fg='red',bg='light blue',justify='center',font=('times',16))
        l2=Label(self,text="Amount Withdraw",fg='red',bg='light blue',justify='center',font=('times',16))
        ...
        self.b1=Button(self,text="Withdraw",fg='red',bg='light blue',justify='center',font=('times',16),bd=6,command=self.withdraw)
    ...
    def withdraw(self):
        ...
        if(i==1):
            j=cur.execute("insert into trans values(%d,'%s',%f,'%s')"%(acno,ndate,amt,'W'))
            if(j==1):
                con.commit()
